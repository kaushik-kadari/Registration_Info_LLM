...
const Login = ({ onLogin }) => {
  ...
  return (
    <div className='d-flex justify-center justify-items-center form-bg'>
       <form className="form">
        ...
        <div className="inputForm">
          <svg height="20" viewBox="-64 0 512 512" width="20">
            ...
            <path fill='#ffffff' d="m304 224c-8.832031 0-16-7.167969-16-16v-80c0-52.929688-43.070312-96-96-96s-96 43.070312-96 96v80c0 8.832031-7.167969 16-16 16s-16-7.167969-16-16v-80c0-70.59375 57.40625-128 128-128s128 57.40625 128 128v80c0 8.832031-7.167969 16-16 16zm0 0"></path>
          </svg>
          <input type={showPassword ? "text" : "password"} className="inputLogin" placeholder="Enter your Password" value={password} onChange={(e) => setPassword(e.target.value)} required/>
          <button className='m-3' onClick={togglePasswordVisibility}><svg viewBox="0 0 576 512" height="1em">
        ...
        <div className="flex-row">
          ...
          <Link to="/resetpassword" ><span className="span">Forgot password?</span></Link>
        </div>
